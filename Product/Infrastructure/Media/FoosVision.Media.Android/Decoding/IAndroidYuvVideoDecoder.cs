...
public interface IAndroidYuvVideoDecoder : IDisposable
{
    ...
    bool TryDequeueFrame([NotNullWhen(true)] out AndroidYuvDecodedFrame? frame);

    void Flush(bool waitForEndOfStream = false);
