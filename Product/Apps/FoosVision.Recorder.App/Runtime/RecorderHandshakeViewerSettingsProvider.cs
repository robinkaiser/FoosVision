...
public class RecorderHandshakeViewerSettingsProvider : IHandshakeViewerSettingsProvider
{
    public HandshakeViewerSettings GetViewerSettings()
    {
        ViewerLiveVideoSettings? liveVideo = RecorderLoggingBootstrap.CurrentSettings?.Settings.Viewer.LiveVideo;
